...
{
	import external.AGALMiniAssembler;
	...
	public class ImageBatch extends DisplayObject 
	{
		...
		private var _clonedItems:Vector.<BatchyItem>;
		
		private var items:Vector.<BatchyItem>;
		...
		public function addItem():BatchyItem
		{
			var item:BatchyItem;
		...
		public function removeItem(item:BatchyItem):void
		{
		...
		public function removeItemAt(index:int):void
		{
			...
			_drawCount--;
			var item:BatchyItem = items[index];
			items[index] = items[_drawCount];
			items[index].dirty = 3;
			items[_drawCount] = item;
		}
		...
		public override function render(support:RenderSupport, alpha:Number):void
        {
            ...
            var item:BatchyItem, vOffset:int, cOffset:int, uOffset:int,
		 ...
		 */
		public function getItems():Vector.<BatchyItem>
		{
			return items;
		}
