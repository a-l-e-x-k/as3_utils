...
package external.bouncyShield.fl.livepreview {
	 ...
	 * This should be the case if you drag the component from the Library bouncer or from the
	 * Components bouncer.</li>
	 ...
	 * SWF file.</li>
     * <li>Right-click the asset in the Library bouncer and select Component Definition from the context menu.</li>
